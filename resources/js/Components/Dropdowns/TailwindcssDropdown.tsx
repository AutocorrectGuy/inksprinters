...
const TailwindcssDropdown = ({ items, selectedItem, onSelect, width = 100, label }: Props) => {
  ...
  return (
    <div
      ref={dropdownRef}
      className={`${label ? 'group flex cursor-pointer items-center justify-between rounded-lg bg-base-300' : ''}`}
