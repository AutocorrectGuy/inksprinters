...
import { collectForeignCharacters } from '@/Pages/Welcome/ExcelToText/utils/Encoding/collectForeignCharacters'
...
const TextEditorOptions = ({ handleCopy, handleDownload }: Props) => {
  ...
  return (
    <div className="col-span-2 flex h-full w-60 flex-col justify-between gap-2 border-r-2 border-r-base-200 pr-3 text-sm">
      {/* Top options*/}
